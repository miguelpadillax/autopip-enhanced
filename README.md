...
## 🚀 Features
 ...
 |---|---|
 | Auto PiP | Enters PiP when you leave YouTube and conditions are met |
...
3. If no trusted interaction is available, an interaction gate is shown in YouTube.
...
- PiP activation is restricted by browser user-gesture policies. If no valid interaction happened on YouTube yet, the extension shows an interaction gate; confirming it provides the required gesture so PiP can start.
